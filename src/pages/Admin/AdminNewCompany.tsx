  ...
  return (
    <>
      ...
      <div className="flex-1 p-6 bg-[var(--color-card-bg)] rounded-lg shadow-xl">
        <h2 className="text-2xl font-bold text-[var(--color-page-text-title)] mb-6">Nueva empresa</h2>
        ...
        <section className="bg-[var(--color-page-bg)] rounded-md">
          <div className="p-10">
            <form onSubmit={handleSubmit}>
              <h3 className="text-lg font-bold text-[var(--color-page-text-title)] mb-4">Datos de la empresa</h3>
              ...
              <h3 className="text-lg font-bold text-[var(--color-page-text-title)] mb-4">Administrador de empresa</h3>
