...
const Dropdown: React.FC<DropdownProps> = ({
  ...
  className = "p-2 bg-[var(--color-card-bg)] border border-[var(--color-border)] text-[var(--color-page-text)] rounded-md w-full focus:outline-none focus:ring-2 text-[#0a2c6d] focus:ring-blue-500 hover:cursor-pointer",
